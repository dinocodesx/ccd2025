    ...
    return (
      <div className="gap-6 p-4 min-h-[200px] flex flex-wrap items-center justify-center ">
        {logos.map((company, idx) => (
          <div className="relative rounded-lg overflow-hidden w-[50%] sm:w-1/4  aspect-[2/1] flex items-center justify-center bg-white p-1 md:w-1/6 lg:w-2/9" key={idx} title={company.name}>
